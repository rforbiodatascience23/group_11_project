...
```{r}
#Summary statistics
summary_statistics <- summary(prostate_data_augment)
summary_statistics
```
...
haem_and_tumor_plot 
```
Tumor size and haemoglobin don't have much correlation but on each stage of the cancer. However, high haemoglobin levels show higher risk for patients and thus higher number of gleason stage.
