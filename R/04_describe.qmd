...
```{r}
#| label: Distribution of Age based on stage
...
=======
#age_distribution 
>>>>>>> a1a0026376eb2d9095a9442961b4fff546606b00
...
#Save
ggsave('../results/ap_vs_bm.png',ap_bm_relationship)
```

```{r}

plot1 <-prostate_data_augment|>
  ...
  labs(x = "Weight index", y = "Systolic blood pressure") +
...
plot2 <-prostate_data_augment|>
  ...
  facet_wrap(~`Cause of Death`,labeller = labeller(`Cause of Death` = c(
    ...
    #7 ~ "unspecified non", #maybe delete
   # 8 ~ "unknown cause"))) + #maybe delete
  labs(x = "Diastolic blood pressure", y = "Systolic blood pressure", title = "Systolic vs diastolic blood pressure by Cause of Death") +
  scale_color_discrete(name = "Cause of Death", labels = c(
    "0" = "Prostate Cancer",
    "3" = "Other Cancer",
    "1" = "Heart or Vascular Disease",
...
#| warning: false
plot4 <-ggplot(prostate_data_augment,aes(x = `Weight index`,fill = as.factor(`Activity Level`))) +
  geom_density(alpha=0.3) +
